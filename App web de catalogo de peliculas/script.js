const apiKey = 'f4a3f89142aaf5500d2d7088288ee17a'; // Reemplaza con tu clave API
...
async function showMovieDetails(movieId) {
    try {
        ...
        // Mostrar la sección de detalles de la película
        movieDetails.classList.remove('hidden');

        // Actualizar el ID de la película seleccionada
