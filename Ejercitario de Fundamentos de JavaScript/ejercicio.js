...
function canBuyProduct() {
    ...
    const dineroTotal = 1150

    const precioDescuento = (precio * (1 - descuento))

    console.log("¿Puedo comprear el producto?", dineroTotal >= precioDescuento)
...
function logVersion() {
    let vesion = 2024
    console.log('La version de JavaScript es: ' + 2024)
}
